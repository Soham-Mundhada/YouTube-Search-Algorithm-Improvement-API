...
def api_service_top():
    ...
    #print(user_query)
    data=db.get_data(user_query)
    if(data==""):
      data=key_words(user_query,500)
      json_dump=json.dumps(data)
      db.insert_data(user_query,json_dump)
      return json_dump
    return data
